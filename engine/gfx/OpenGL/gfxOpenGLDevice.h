...
namespace Mango
{
   class GFXOpenGLDevice : public GFXDevice
   {
      ...
      struct GLPipeline
      {
         ...
         GLint pushConstantIndex;
         U32 pushConstantBufferSize;
         GLuint pushConstantBufferHandle;
      };
      ...
      struct
      {
         ...
         GLuint pushConstantBuffer = 0;
         GLuint currentMappedBuffer = 0;
         GLenum currentMappedBufferType = 0;
         GLuint globalVAO = 0;
         RenderPassHandle currentRenderPass = 0;
      } mState;
   ...
   public:
      explicit GFXOpenGLDevice(void* window);
